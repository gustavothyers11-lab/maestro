      ...
      <div className="border-b border-gray-100 dark:border-white/[0.05] bg-gradient-to-r from-gray-50 to-white dark:from-white/[0.05] dark:to-white/[0.02] px-6 py-4">
        <div className="flex items-start justify-between gap-4">
          ...
          <button
            ...
            disabled={excluindo}
            title="Excluir aula"
            className="inline-flex items-center justify-center rounded-lg p-2 text-red-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors disabled:opacity-50 flex-shrink-0"
          >
            {excluindo ? (
